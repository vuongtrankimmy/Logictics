...
namespace Entities.OwnerModels.Logictics.Systems.Units.Unit
{
    [BsonIgnoreExtraElements]
    public partial class UnitModel:BaseModel
    {
        ...
        [JsonProperty("ShortName", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
